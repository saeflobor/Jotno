        ...
        <div className="relative min-h-screen overflow-hidden">
          <div
            ...
            style={{
              backgroundImage: `url(${
                useDarkBackground
                  ? "/Smiling_Old_Couple_Black.jpg"
                  : "/Smiling_Old_Couple_White.png"
              })`,
            }}
          />
          <div
            className={`absolute inset-0 ${
              useDarkBackground ? "bg-black/70" : "bg-white/30"
            }`}
            aria-hidden="true"
          />
                ...
                <div className="md:w-1/2">
                  ...
                  <p
                    className={`text-lg mb-6 ${
                      useDarkBackground ? "text-gray-400" : "text-gray-700"
                    }`}
                  >
                    যত্ন : Jotno helps elderly users have their healthcare needs
                    met, while keeping families connected and informed.
                  </p>
                ...
                {features.map((feature) => {
                  ...
                  return (
                    <div
                      ...
                      } backdrop-blur-[40px] p-6 rounded-xl shadow-md hover:shadow-lg transition duration-300`}
                    >
